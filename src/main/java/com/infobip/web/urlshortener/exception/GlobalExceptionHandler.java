...
import com.infobip.web.urlshortener.error.ApiError;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMissingServletRequestParameter(MissingServletRequestParameterException ex,
                                                                          ...
                                                                          HttpStatus status,
                                                                          WebRequest request) {
        log.warn(String.format("%s caught", ex.getClass().getSimpleName()), ex);
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
                                                                  ...
                                                                  HttpStatus status,
                                                                  WebRequest request) {
        log.warn(String.format("%s exception caught", ex.getClass().getSimpleName()), ex);
    ...
    protected ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex,
        ...
        log.warn(String.format("%s caught", ex.getClass().getSimpleName()), ex);
        ApiError apiError = new ApiError(BAD_REQUEST);
        String simpleName = ex.getRequiredType() == null ? "" : ex.getRequiredType().getSimpleName();
    ...
    @ExceptionHandler({
            ...
            UrlAlreadyAssignedException.class,
    ...
    @ExceptionHandler({
            ...
            WebsiteNotFoundException.class
    })
    ...
    public ResponseEntity<Object> handleInternalExceptions(Exception ex) {
        log.error(String.format("%s caught", ex.getClass().getSimpleName()), ex);
